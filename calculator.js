...
function getOption1() {
    ...
    //why += +??
    total1 += +obj.options[obj.selectedIndex].getAttribute("data-cost");
}
...
function getOption2() {
    ...
    //why += +??
    total2 += +obj.options[obj.selectedIndex].getAttribute("data-cost");
}
...
function getOption3() {
    ...
    //why += +??
    total3 += +obj.options[obj.selectedIndex].getAttribute("data-cost");
}

var finalTotal = 0;
function computeTotal() {
    finalTotal = total1 + total2 +total3;
    document.getElementsByClassName("screen")[0].innerHTML = finalTotal;
}
